...
export function ProductColorIcon() {
  return (
    <svg width="19" height="21" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M5.833 9.625V17.5c0 .63-.256 1.207-.665 1.627l-.023.024a1.83 1.83 0 0 1-.163.146 2.041 2.041 0 0 1-.578.35c-.064.029-.128.052-.192.075-.228.076-.473.111-.712.111a2.48 2.48 0 0 1-.467-.046c-.075-.018-.151-.035-.227-.059a2.117 2.117 0 0 1-.268-.099c0-.006 0-.006-.006 0a2.946 2.946 0 0 1-.467-.286l-.006-.006a1.598 1.598 0 0 1-.21-.186c-.064-.07-.128-.14-.192-.216a2.94 2.94 0 0 1-.286-.467c.006-.006.006-.006 0-.006 0 0 0-.006-.006-.011a3.334 3.334 0 0 1-.093-.257c-.024-.076-.041-.152-.059-.227a2.483 2.483 0 0 1-.046-.467V9.625c0-.875.583-1.459 1.458-1.459h1.75c.875 0 1.458.584 1.458 1.459Z"
        stroke="#222F5D"
        strokeWidth=".875"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M12.833 16.625v1.75c0 .875-.583 1.458-1.458 1.458H3.5c.24 0 .484-.035.712-.11.064-.024.128-.047.192-.076.204-.082.403-.199.578-.35.052-.041.11-.094.163-.146l.023-.024 3.967-3.96h2.24c.875 0 1.458.583 1.458 1.458ZM2.806 19.729a2.237 2.237 0 0 1-.957-.578 2.237 2.237 0 0 1-.577-.957c.227.73.805 1.307 1.534 1.535Z"
        stroke="#222F5D"
        strokeWidth=".875"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="m10.716 13.586-1.581 1.58-3.967 3.961c.409-.42.665-.997.665-1.627v-5.635l1.581-1.58c.618-.62 1.447-.62 2.065 0l1.237 1.236c.618.618.618 1.446 0 2.065ZM3.5 18.083a.583.583 0 1 0 0-1.167.583.583 0 0 0 0 1.167Z"
        stroke="#222F5D"
        strokeWidth=".875"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function DigikalaBusiness() {
  return (
    <svg
      width="123"
      height="16"
...
export function DigikalaService() {
  return (
    <svg
      width="111"
      height="16"
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <g clipPath="url(#clip0_879_162962)">
        <path
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M11.1424 0C11.4663 0 11.8741 0.408767 11.8741 0.731707V14.878C11.8741 15.2009 11.4663 15.6098 11.1424 15.6098H9.67895C9.35514 15.6098 8.94724 15.2011 8.94724 14.878V14.3902L8.17997 15.2113C7.9721 15.4421 7.57125 15.6098 7.23992 15.6098H4.55699C2.20287 15.6098 0.166748 13.5681 0.166748 11.2195V8.31502C0.166748 5.96639 2.20287 3.90244 4.55699 3.90244H8.94724V0.731707C8.94724 0.408767 9.35514 0 9.67895 0H11.1424ZM3.09358 11.2195C3.09358 11.9753 3.79945 12.6829 4.55699 12.6829H8.94724V6.82927H4.55699C3.79945 6.82927 3.09358 7.53691 3.09358 8.29268V11.2195ZM29.435 4.63415V15.6098V15.8537C29.435 18.2023 27.3989 20 25.0448 20H22.7826C22.4459 20 22.1288 19.8426 21.9257 19.5746L20.638 17.8744C20.4241 17.5921 20.5438 17.0732 20.8985 17.0732H25.0448C25.8023 17.0732 26.5082 16.6094 26.5082 15.8537V15.6098H22.118C19.764 15.6098 17.7277 13.5681 17.7277 11.2195V8.29268C17.7277 5.94417 19.764 3.90244 22.118 3.90244H24.8009C25.1367 3.90244 25.5026 4.17252 25.7396 4.39024L26.5082 5.12195V4.63415C26.5082 4.31176 26.9169 3.90244 27.2399 3.90244H28.7033C29.027 3.90244 29.435 4.3111 29.435 4.63415ZM26.5082 6.82927H22.118C21.3603 6.82927 20.6546 7.53691 20.6546 8.29268V11.2195C20.6546 11.9755 21.3603 12.6829 22.118 12.6829H26.5082V6.82927ZM35.2887 15.6098V4.63415C35.2887 4.3111 35.6967 3.90244 36.0204 3.90244H37.4838C37.8069 3.90244 38.2155 4.31176 38.2155 4.63415V5.12195L38.9842 4.39024C39.2212 4.17252 39.5871 3.90244 39.9229 3.90244H42.6058C44.9598 3.90244 46.996 5.94417 46.996 8.29268V11.2195C46.996 13.5681 44.9598 15.6098 42.6058 15.6098H38.2155V18.5366C38.2155 19.3448 37.5603 20 36.7521 20C35.9439 20 35.2887 19.3448 35.2887 18.5366V15.6098ZM42.6058 6.82927H38.2155V12.6829H42.6058C43.3634 12.6829 44.0692 11.9755 44.0692 11.2195V8.29268C44.0692 7.53691 43.3634 6.82927 42.6058 6.82927ZM64.557 5.36561C64.557 4.55748 63.902 3.90233 63.0938 3.90219C62.2855 3.90206 61.6302 4.55729 61.6302 5.36561V10.7317L61.6275 10.8127C61.5796 11.5389 60.8955 12.1951 60.1668 12.1951H57.2399L57.1591 12.1925C56.4343 12.1446 55.7765 11.4623 55.7765 10.7317V5.36561C55.7765 4.55729 55.1212 3.90206 54.3129 3.90219C53.5047 3.90233 52.8497 4.55748 52.8497 5.36561V10.7317L52.8516 10.8575C52.9227 13.1578 54.9332 15.122 57.2399 15.122H60.1668L60.2923 15.12C62.5875 15.0491 64.557 13.0437 64.557 10.7317V5.36561ZM31.6302 0C31.3066 0 30.8985 0.408767 30.8985 0.731707V2.19512C30.8985 2.51806 31.3066 2.92683 31.6302 2.92683H33.0936C33.4173 2.92683 33.8253 2.51806 33.8253 2.19512V0.731707C33.8253 0.408767 33.4173 0 33.0936 0H31.6302ZM30.8985 4.63415C30.8985 4.31132 31.3066 3.90244 31.6302 3.90244H33.0936C33.4173 3.90244 33.8253 4.31132 33.8253 4.63415V14.878C33.8253 15.2009 33.4173 15.6098 33.0936 15.6098L31.7449 15.625C31.4213 15.625 30.8985 15.2009 30.8985 14.878V4.63415ZM14.0692 0C13.7455 0 13.3375 0.408767 13.3375 0.731707V2.19512C13.3375 2.51806 13.7455 2.92683 14.0692 2.92683H15.5326C15.8563 2.92683 16.2643 2.51806 16.2643 2.19512V0.731707C16.2643 0.408767 15.8563 0 15.5326 0H14.0692ZM13.3375 4.63415C13.3375 4.31132 13.7455 3.90244 14.0692 3.90244H15.5326C15.8563 3.90244 16.2643 4.31132 16.2643 4.63415V14.878C16.2643 15.2009 15.8563 15.6098 15.5326 15.6098H14.0692C13.7455 15.6098 13.3375 15.2009 13.3375 14.878V4.63415ZM51.3863 0.731707V14.878C51.3863 15.2009 50.9784 15.6098 50.6546 15.6098H49.1911C48.8673 15.6098 48.4594 15.2009 48.4594 14.878V0.731707C48.4594 0.408767 48.8673 0 49.1911 0H50.6546C50.9784 0 51.3863 0.408767 51.3863 0.731707ZM66.5082 14.1437C66.5082 14.9534 67.1646 15.6098 67.9743 15.6098H74.3764C76.1753 15.6098 77.6897 14.1838 77.727 12.3757C77.7588 10.833 76.7307 9.48119 75.2488 9.10359L69.2159 7.56637C69.0308 7.51922 68.9087 7.33704 68.9427 7.14035C68.9739 6.95991 69.1405 6.83446 69.3227 6.83446L75.7739 6.83452C76.5836 6.83453 77.2399 6.17816 77.2399 5.36848C77.2399 4.55881 76.5836 3.90244 75.7739 3.90244H69.3717C67.5728 3.90244 66.0584 5.32831 66.0211 7.13639C65.9893 8.67915 67.0174 10.0309 68.4992 10.4085L74.5323 11.9458C74.7172 11.993 74.8394 12.1752 74.8054 12.3718C74.7742 12.5523 74.6077 12.6777 74.4254 12.6777H67.9743C67.1646 12.6777 66.5082 13.334 66.5082 14.1437Z"
        fill="#424750"
      />
      <mask
        id="mask0"
      ...
      <g mask="url(#mask0)">
        <rect x="0.166748" width="78" height="20" fill="#424750" />
      </g>
    </svg>
  );
}

export function Digistyle() {
  return (
    <svg
      width="86"
      height="13"
...
export function Ganjeh() {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <g clipPath="url(#clip0_3913_7701)">
        <path
